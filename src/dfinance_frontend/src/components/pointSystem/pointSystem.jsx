...
<div>
  ...
  <span className="ml-2">Lending Positions</span>
                    ...
                    <ul className="text-sm space-y-2 text-[#2A1F9D] dark:text-darkTextSecondary">
                      ...
                      <li>✔️ <b>2</b> points per dollar per day in BTC/ETH/ICP</li>
                      <li>✔️ <b>1</b> point per dollar per day in anything else (e.g., Liquid Staked tokens)</li>
                    </ul>
                  </div>
  ...
  <span className="ml-2">Borrow Positions</span>
                    ...
                    <ul className="text-sm space-y-2 text-[#2A1F9D] dark:text-darkTextSecondary">
                      ...
                      <li>✔️ <b>2</b> points per dollar per day in BTC/ETH/ICP</li>
                      <li>✔️ <b>1</b>  point per dollar per day in Stables</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lgx:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 flex flex-col dark:bg-bottom-left-to-top-right-gradient p-8 rounded-2xl shadow-xl">
                    <h3 className="text-lg font-semibold mb-2 text-[#2A1F9D] dark:text-darkTextSecondary1">First 7 Days</h3>
                    <p className="text-sm text-[#2A1F9D] dark:text-darkTextSecondary">
                      Lending within the first 7 days gives you a permanent boost of <b>2x</b> for as long as those funds remain in those positions.
                    </p>
                  </div>
                  <div className="bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 flex flex-col dark:bg-bottom-left-to-top-right-gradient p-8 rounded-2xl shadow-xl">
                    <h3 className="text-lg font-semibold mb-2 text-[#2A1F9D] dark:text-darkTextSecondary1">Same Asset</h3>
                    <p className="text-sm text-[#2A1F9D] dark:text-darkTextSecondary">
                      If you provide the same asset in lending and borrowing positions, points are decreased by <b>0.5x</b>.
                    </p>
                  </div>
                  <div className="bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 flex flex-col dark:bg-bottom-left-to-top-right-gradient p-8 rounded-2xl shadow-xl">
                    <h3 className="text-lg font-semibold mb-2 text-[#2A1F9D] dark:text-darkTextSecondary1">Liquidity</h3>
                    <p className="text-sm text-[#2A1F9D] dark:text-darkTextSecondary">
                      We can reduce the points by <b>0.5x</b> for the debt user and increase the points by 1.5x for the liquidator for the particular transaction.
                    </p>
                  </div>
                  <div className="bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 flex flex-col dark:bg-bottom-left-to-top-right-gradient p-8 rounded-2xl shadow-xl">
                    <h3 className="text-lg font-semibold mb-2 text-[#2A1F9D] dark:text-darkTextSecondary1">Repay</h3>
                    <p className="text-sm text-[#2A1F9D] dark:text-darkTextSecondary">
                      We calculate the debt amount repaid and the collateral amount being liquidated, then adjust points by <b>1x/1.5</b> for both on the user side.
                    </p>
                  </div>
                </div>
              </div>
  ...
  <div className="p-4 bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 dark:bg-bottom-left-to-top-right-gradient rounded-lg text-[#2A1F9D] dark:text-darkText">
    ...
    <p>For example,  3 x $100 in stable coin lent = 300 points. With the bonus = 600 points
    </p>
  </div>
</div>
