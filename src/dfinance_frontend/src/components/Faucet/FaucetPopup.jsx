          ...
          <div className="w-[325px] lg1:w-[420px] absolute bg-white shadow-xl rounded-[1rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-7 text-[#2A1F9D] dark:bg-[#252347] dark:text-darkText z-50">
            ...
            <div>
              {(() => {
                ...
                console.log("Remaining Amount:", formattedAmount); // Log the remaining amount in human-readable form
                console.log("FaucetLimit:", FaucetLimit[asset]); // Log the faucet limit
                console.log("FaucetUsage:", FaucetUsage[asset]); // Log the faucet usage
