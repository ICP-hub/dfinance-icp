...
# Set variables
ckbtc_canister="ajuq4-ruaaa-aaaaa-qaaga-cai" 
# ckbtc_canister=$CANISTER_ID_CKETH_LEDGER
backend_canister=$CANISTER_ID_DFINANCE_BACKEND  
# dtoken_canister=$CANISTER_ID_DTOKEN
dckBTC="a3shf-5eaaa-aaaaa-qaafa-cai"
...
user1_dtoken=$(dfx canister call $dckBTC icrc1_balance_of "(record {owner=principal\"${user1_principal}\"; subaccount=null})")
