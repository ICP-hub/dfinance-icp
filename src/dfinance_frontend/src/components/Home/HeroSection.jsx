  ...
  return (
      <div id="hero" className="flex justify-center text-2xl md:text-[32px] xl:text-[45px] font-medium lg:font-extralight text-[#2A1F9D] mt-4 dark:text-darkText">
          <div className="w-fit xl:w-[700px] gap-2 flex flex-col items-center justify-center px-8">
              <h1 className="lg:my-2">ICP <span className="font-semibold bg-gradient-to-r from-purple-500  to-pink-400 bg-clip-text text-transparent">DeFi</span> Earn And</h1>
              ...
              <div className="w-full mt-8 bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 rounded-3xl text-center p-6 dark:bg-gradient dark:from-darkGradientStart dark:to-darkGradientEnd">
