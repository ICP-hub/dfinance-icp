...
fn setup() -> (PocketIc, Principal, Principal, Principal) {
    ...
    // ====================== ckETH canister ========================
    let cketh_canister = Principal::from_text("ctiya-peaaa-aaaaa-qaaja-cai").unwrap(); //replace it
...
fn update_canister_constants(ckbtc_id: String, dtoken_id: String, backend_id: String) {
