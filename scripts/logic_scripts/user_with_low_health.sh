...
# add tester
# dfx canister call dfinance_backend add_tester "(\"liq_user1\", principal \"lor7f-li7tj-5oqz6-j6aep-pn5sh-f5jct-kn
# 5r4-sa73a-74bf2-zleh4-2ae\")"
ASSET_SUPPLY=0.0045
ASSET_BORROW=0.14
SUPPLY_TOKENS="ckBTC"
BORROW_TOKENS="ckETH"
# dfx canister call dfinance_backend create_user_reserve_with_low_health \
#     "(\"$ASSET_SUPPLY\", \"$ASSET_BORROW\", $SUPPLY_TOKENS, $BORROW_TOKENS)"
