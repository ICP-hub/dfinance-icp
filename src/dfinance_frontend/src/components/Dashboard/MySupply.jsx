                    ...
                    <div
                      className={`relative mt-4 overflow-y-auto scrollbar-custom ${
                        MY_SUPPLY_ASSET_TABLE_ROWS.length <= 3
                          ? `max-h-[${
                              MY_SUPPLY_ASSET_TABLE_ROWS.length * 120
                    ...
                    >
                      ...
                      <div
                        className={`overflow-auto scrollbar-hidden ${
                          MY_SUPPLY_ASSET_TABLE_ROWS.length > 3 ? "h-full" : ""
                        }`}
                      >
                            ...
                            {MY_SUPPLY_ASSET_TABLE_ROWS.slice(0, 8).map(
                              (item, index) => (
                                ...
                                >
                                  ...
                                  <td className="p-3 align-top pl-10 mt-1.5">
                                    {item.apy}
                                  </td>
                                  <td className="p-3 align-top">
                ...
                <>
                  {MY_BORROW_ASSET_TABLE_ROWS.length === 0 ? (
                    ...
                    <div className="w-full h-auto mt-8 relative max-h-[260px] overflow-hidden">
                      ...
                      <div
                        className={`w-full h-auto overflow-y-auto scrollbar-custom ${
                          MY_BORROW_ASSET_TABLE_ROWS.length > 3
