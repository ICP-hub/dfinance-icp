//          //        Aave       //         //
//implement and manage various configuration parameters for financial reserves.

//uses bitmask operations to efficiently store and manipulate configuration parameters within a single 256-bit integer.
//conserves storage space and optimizes gas usage in the Ethereum network, which is essential for minimizing transaction costs.

//provides various functions to set and get the values of configuration parameters.
//manages several boolean flags that control the state of a reserve

//Ensuring Validity

// // The ReserveConfigurationMap struct holds a single u128 (in Rust) or uint256 (in Solidity) value, which stores all configuration parameters in a compact form using bitwise operations. // //
...
pub const LIQUIDATION_THRESHOLD_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFF;
pub const LIQUIDATION_BONUS_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFF;
pub const DECIMALS_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00FFFFFFFFFFFF;
pub const ACTIVE_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFF;
pub const FROZEN_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDFFFFFFFFFFFFFF;
pub const BORROWING_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFBFFFFFFFFFFFFFF;
pub const STABLE_BORROWING_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFFFFF;
pub const PAUSED_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFF;
pub const BORROWABLE_IN_ISOLATION_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDFFFFFFFFFFFFFFF;
pub const SILOED_BORROWING_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFBFFFFFFFFFFFFFFF;
pub const FLASHLOAN_ENABLED_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFFFFFF;
pub const RESERVE_FACTOR_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFFFFFFFFFF;
pub const BORROW_CAP_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000FFFFFFFFFFFFFFFFFFFF;
pub const SUPPLY_CAP_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFFFFFF000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
pub const LIQUIDATION_PROTOCOL_FEE_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
pub const EMODE_CATEGORY_MASK: u128 = 0xFFFFFFFFFFFFFFFFFFFF00FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
pub const UNBACKED_MINT_CAP_MASK: u128 = 0xFFFFFFFFFFF000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
pub const DEBT_CEILING_MASK: u128 = 0xF0000000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
...
impl ReserveConfigurationMap {
    ...
    #[update]
    pub fn set_ltv(&mut self, ltv: u128) {
