...
const FaucetDetails = () => {
  ...
  <div className="w-full flex justify-end align-center">
    <Button
      ...
      className="mb-7 bg-gradient-to-tr md:from-[#4659CF] md:from-20% md:via-[#D379AB] md:via-60% md:to-[#FCBD78] md:to-90% text-white rounded-lg px-3 py-1 shadow-md shadow-black/40 font-semibold text-sm sxs3:px-4 font-inter md:bg-gradient-to-tr from-[#EB8863]/60 to-[#81198E]/60"
