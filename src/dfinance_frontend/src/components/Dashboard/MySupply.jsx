...
import { MY_ASSET_TO_SUPPLY_TABLE_COL, MY_SUPPLY_ASSET_TABLE_COL, MY_SUPPLY_ASSET_TABLE_ROWS, WALLET_ASSETS_TABLE_COL, WALLET_ASSETS_TABLE_ROW } from '../../utils/constants'
                                      ...
                                      <td className="p-3 align-top">
                                          <div className="w-full flex gap-3">
                                              <Button
                                                  ...
                                                  className={"bg-gradient-to-r text-white from-[#4659CF] via-[#D379AB] to-[#FCBD78] rounded-md p-2 px-3 shadow-lg font-semibold text-sm"}
                                              />
                                              <Button
                                                  title={"Withdraw"}
                                                  onClickHandler={() =>
                                                  ...
                                                  className={"bg-gradient-to-r text-white from-[#2A1F9D] to-[#4659CF] rounded-md p-2 px-3 shadow-lg font-semibold text-sm opacity-65"}
                                              />
                                          </div>
                                      </td>
                                  </tr>
