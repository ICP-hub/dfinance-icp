...
export const FAQ_QUESTIONS_POINTSYSTEM = [
  ...
  },
  {
    ...
    answer:
      "Yes, you do. Even though position size and duration are key factors in determining points accrual, there will be various boosts throughout the season where you can significantly boost your points per dollar. Using leverage products can also have a huge impact in this regard.",
  },
  {
    id: 4,
