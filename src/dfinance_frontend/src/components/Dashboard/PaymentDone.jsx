...
const PaymentDone = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full my-2 focus:outline-none bg-gradient-to-r mt-6 bg-[#F6F6F6] rounded-md p-3 px-8 shadow-lg text-sm placeholder:text-white flex flex-col gap-3 items-center">
