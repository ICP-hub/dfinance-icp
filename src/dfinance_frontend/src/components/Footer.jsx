...
import {FOOTER_LINK_1, FOOTER_LINK_2} from "../utils/constants"
...
const Footer = () => {
  return (
      <div className="w-full bg-[#233D63]">
          <footer className="w-full xl3:w-[80%] xl4:w-[60%] xl3:mx-auto mt-24 px-3 xl:px-24 py-[3rem] relative">
            {/* Background Overlay */}
              ...
              <div className="w-full md:w-3/12 text-white mb-5 md:mb-0 md:px-8 xl:px-24 text-sm mt-3">
                  ...
                  <div className="flex gap-2 mt-6">
                      <span className="bg-[#8CC0D7] p-2 w-8 h-8 flex items-center justify-center rounded-md">
                          <img src="./social/discord.svg" alt="facebook" className="w-full h-full object-contain" />
                      </span>
                      <span className="bg-[#8CC0D7] p-2 w-8 h-8 flex items-center justify-center rounded-md">
