...
impl ValidationLogic {
    ...
    pub async fn validate_supply(
        ...
        let final_total_supply = final_amount + reserve.configuration.total_supplies as u128; // reserve total_supply or configuration total_supplies ?
    ...
    pub async fn validate_borrow(reserve: &ReserveData, amount: f64, user_principal: Principal) {
        ...
        let final_total_borrow = amount as u64 + reserve.configuration.total_borrowed as u64;
