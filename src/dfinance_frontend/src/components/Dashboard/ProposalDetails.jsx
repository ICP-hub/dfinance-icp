      ...
      <div className="w-full flex flex-col md2:flex-row mt-4 gap-6 mb-10">
        ...
        <div className="w-full md2:w-4/12 dxl:w-3/12">
          ...
          <div className="w-full bg-[#233D63] p-4 rounded-xl text-white">
            ...
            {isAuthenticated && <>
              <div className="w-full flex mt-8 text-[12px]">
                <p className="flex flex-col gap-1 items-center">Voting Power <span className="text-[10px] text-gray-400">(XYZ + ABXYZ)</span></p>
                <p className="ml-auto text-[16px]">0</p>
              </div>
              <div className="w-full mt-4 my-2 bg-[#935D6D] rounded-xl p-3 shadow-lg font-light text-[12px] flex gap-3">
                <Info size={20} />
                <p>Not enough voting power to participate in this proposal</p>
              </div>
            </>}
          </div>
