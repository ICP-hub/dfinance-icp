    ...
    <>
      <div className="w-full mt-6">
        ...
        <div className="w-full flex flex-col  md2:flex-row mt-2">
          ...
          <div className="w-full justify-start md2:w-5/12 dxl:w-4/12 md2:p-6 md2:ml-16">
            <h1 className="text-[#2A1F9D] font-medium text-xl mx-5 lg:mx-10 dark:text-darkText">
              Others
            </h1>
      ...
      <div className="w-full flex flex-col md2:flex-row mt-8 my-4 gap-8">
        <div className="w-full md2:w-8/12 dxl:w-9/12 h-[620px] p-6 bg-gradient-to-r from-[#4659CF]/40 via-[#D379AB]/40 to-[#FCBD78]/40 rounded-3xl pt-10 dark:bg-gradient dark:from-darkGradientStart dark:to-darkGradientEnd">
          <div className="flex items-center justify-between ">
            ...
            <div className="flex relative gap-1 items-center">
              {showsearch && (
                <div className="test">
                  <input
                    ...
                    className={`placeholder-gray-500 w-[400px] md:block hidden z-20 px-4 py-[7px] focus:outline-none box bg-transparent ${
                      showsearch
              ...
              >
                ...
                />
                <path
                  d="M13.5 12.75L15.75 12.75"
                  stroke="#998FFF"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M11.25 5.25L15.75 5.25"
                  stroke="#998FFF"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M4.5 5.25C4.5 4.55109 4.5 4.20163 4.61418 3.92597C4.76642 3.55843 5.05843 3.26642 5.42597 3.11418C5.70163 3 6.05109 3 6.75 3C7.44891 3 7.79837 3 8.07403 3.11418C8.44157 3.26642 8.73358 3.55843 8.88582 3.92597C9 4.20163 9 4.55109 9 5.25C9 5.94891 9 6.29837 8.88582 6.57403C8.73358 6.94157 8.44157 7.23358 8.07403 7.38582C7.79837 7.5 7.44891 7.5 6.75 7.5C6.05109 7.5 5.70163 7.5 5.42597 7.38582C5.05843 7.23358 4.76642 6.94157 4.61418 6.57403C4.5 6.29837 4.5 5.94891 4.5 5.25Z"
                  stroke="#998FFF"
                />
                <path
                  d="M9 12.75C9 12.0511 9 11.7016 9.11418 11.426C9.26642 11.0584 9.55843 10.7664 9.92597 10.6142C10.2016 10.5 10.5511 10.5 11.25 10.5C11.9489 10.5 12.2984 10.5 12.574 10.6142C12.9416 10.7664 13.2336 11.0584 13.3858 11.426C13.5 11.7016 13.5 12.0511 13.5 12.75C13.5 13.4489 13.5 13.7984 13.3858 14.074C13.2336 14.4416 12.9416 14.7336 12.574 14.8858C12.2984 15 11.9489 15 11.25 15C10.5511 15 10.2016 15 9.92597 14.8858C9.55843 14.7336 9.26642 14.4416 9.11418 14.074C9 13.7984 9 13.4489 9 12.75Z"
                  stroke="#998FFF"
                />
              </svg>
          ...
          {showsearch && (
            <input
              ...
              className={`placeholder-gray-500 w-[250px] block md:hidden z-20 px-4 py-[7px] mt-2 focus:outline-none box bg-transparent ${
                showsearch
                  ? "animate-fade-left flex"
                  : "animate-fade-right hidden"
              }`}
          ...
          <div className="w-full mt-8">
            {[1, 2, 3, 4].map((i, index) => (
              <div
                key={i}
                className={`w-full flex flex-col sm:flex-row rounded-lg p-3 ${
              ...
              >
                <div className="w-full sm:w-9/12 flex flex-col gap-6 ">
                  <Link
                    to={"proposal-details"}
                    className="text-[#2A1F9D] text-lg font-semibold  ml-[-0.2rem] mt-2 dark:text-darkText"
                  >
                    weETH Onboarding
                  </Link>
        ...
        <div className="w-full md2:w-4/12 dxl:w-3/12">
          {!isAuthenticated && (
            <div className="w-full bg-[#233D63] p-4 rounded-2xl text-white mb-4">
            ...
            <div className="w-full bg-[#233D63] p-4 rounded-2xl text-white mb-4">
              ...
              <div className="w-full mt-3 text-[12px]">
                <div className="flex">
                  ...
                  <p className="ml-auto text-[16px]">0</p>
                </div>
                <div className="flex">
                  <p className="flex flex-row gap-3 items-center">
                    Proposition Power{" "}
            ...
            <div className="w-full bg-[#233D63] p-4 rounded-2xl text-white mb-4">
              ...
              <div className="w-full mt-4 text-[12px]">
                <p className="mb-3 ">
                  ...
                  time.{" "}
                  <a href="#" className="text-blue-400 italic underline">
                    Learn more.
                  </a>
                </p>
            ...
            <div className="w-full bg-[#233D63] p-4 rounded-2xl text-white mb-4">
              ...
              <div className="w-full mt-3 text-[12px]">
                <div className="flex">
                  ...
                  <div
                    className="ml-auto flex justify-center align-center items-center gap-2 bg-gradient-to-tr from-[#EDD049] to-[#8CC0D7] bg-clip-text text-transparent rounded-lg px-2 p-2 h-7 border mb-2 cursor-pointer"
                ...
                <div className="flex">
                  <div className="flex align-center items-center">
                    <img
                      src="https://cryptologos.cc/logos/algorand-algo-logo.svg?v=032"
                      alt="Icp Logo"
                      className="mx-2 w-5 h-5 rounded-[50%] bg-gray-300"
                    />
                    <p className="text-[12px] font-light">Algorand</p>
                  </div>
                  <div
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
              <div className="bg-white dark:bg-darkOverlayBackground px-6 py-4 rounded-lg shadow-lg w-80 relative">
                    ...
                    <div>
                      <div className="flex items-center mb-3">
                        <div className="flex align-center items-center">
                          ...
                          />
                          <p className="text-[12px] font-light text-[#2A1F9D] dark:text-darkText">
                            Avalanche
                          </p>
                        </div>
                      ...
                      <div className="flex items-center mb-3">
                        <div className="flex align-center items-center">
                          <img
                            src="https://cryptologos.cc/logos/algorand-algo-logo.svg?v=032"
                            alt="Icp Logo"
                            className="mx-2 w-7 h-7 rounded-[50%] bg-gray-300"
                          />
                          <p className="text-[12px] font-light text-[#2A1F9D] dark:text-darkText">
                            Algorand
                          </p>
                ...
                <div className="flex w-full justify-center">
                  <button className="mt-6 bg-gradient-to-tr from-[#4C5FD8] via-[#D379AB] to-[#FCBD78] text-white rounded-lg px-6 py-3 font-semibold w-[100%] text-[14px]">
                    Confirm Transaction
                  </button>
                </div>
              </div>
            ...
            <Modal open={isWalletModalOpen} onClose={handleWalletConnect}>
              <div className="w-[300px] absolute bg-gray-100  shadow-xl rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 text-white dark:bg-darkOverlayBackground font-poppins">
                ...
                <div className="flex flex-col gap-2 mt-3 text-sm">
                  ...
                  <div
                    className="w-full flex items-center justify-between bg-[#c8c8c8] bg-opacity-20 hover:bg-[#b7b4b4] cursor-pointer p-2 rounded-md text-[#2A1F9D] dark:bg-darkBackground/30 dark:hover:bg-[#b7b4b4] dark:text-darkText"
