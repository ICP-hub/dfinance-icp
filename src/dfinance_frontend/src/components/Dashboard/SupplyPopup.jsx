        ...
        <>
            ...
            <div className='flex flex-col gap-2 mt-5 text-sm'>
                <div className="w-full">
                    ...
                    <div className="w-full flex items-center justify-between bg-gray-100 hover:bg-gray-300 cursor-pointer p-3 rounded-md dark:bg-darkBackground/30 dark:text-darkText">
            ...
            {!hasEnoughBalance && (
                <div className="w-full flex items-center text-[11px] mt-3 bg-yellow-100 p-2 rounded-md dark:bg-[#59588D]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 mr-1 text-yellow-500 dark:text-darkText">
                    ...
                    <p className="text-yellow-700   dark:text-darkText">
