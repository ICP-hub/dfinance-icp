        ...
        (
            ...
            ReserveData {
                ...
                configuration: ReserveConfiguration {
                    ltv: ScalingMath::to_scaled(73),
                    liquidation_threshold: ScalingMath::to_scaled(78),
                    liquidation_bonus: ScalingMath::to_scaled(5),
                    borrowing_enabled: true,
                    frozen: false,
                    active: true,
                    paused: false,
                    borrow_cap: ScalingMath::to_scaled(10000000000),
                    supply_cap: ScalingMath::to_scaled(10000000000),
    ...
    assets.insert(
        ...
        (
            ...
            ReserveData {
                ...
                id: 2,
                configuration: ReserveConfiguration {
                    ltv: ScalingMath::to_scaled(80),
                    liquidation_threshold: ScalingMath::to_scaled(83),
                    liquidation_bonus: ScalingMath::to_scaled(5),
                    borrowing_enabled: true,
                    frozen: false,
                    active: true,
    ...
    assets.insert(
        ...
        (
            ...
            ReserveData {
                ...
                id: 3,
                configuration: ReserveConfiguration {
                    ltv: ScalingMath::to_scaled(58),
                    liquidation_threshold: ScalingMath::to_scaled(63),
                    liquidation_bonus: 0,
                    borrowing_enabled: true,
                    frozen: false,
                    active: true,
        ...
        (
            ...
            ReserveData {
                ...
                configuration: ReserveConfiguration {
                    ltv: ScalingMath::to_scaled(75),
                    liquidation_threshold: ScalingMath::to_scaled(78),
                    liquidation_bonus: ScalingMath::to_scaled((45 / 10)),
                    borrowing_enabled: true,
                    frozen: false,
                    active: true,
                    paused: false,
