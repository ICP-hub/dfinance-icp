...
const EModeButton = () => {
    ...
    const handleSettingClick = () => {
        setShowInitialPopup(!showInitialPopup); // Toggle showInitialPopup state
    };
    ...
    return (
        <ClickAwayListener onClickAway={handleClickAway}>
            <div className="relative">
                ...
                {showInitialPopup && (
                    <div className="absolute right-0 mt-2 w-80 flex items-center justify-center">
                        <div className="bg-white border rounded-lg shadow-lg p-6 relative w-full flex flex-col justify-between">
                            <button
                            ...
                            <div>
                                <h2 className="text-xl font-semibold mb-4">Efficiency mode (E-Mode)</h2>
                ...
                {showFinalPopup && (
                    <ClickAwayListener onClickAway={handleClickAway}>
                        <div className="fixed inset-0 flex items-center justify-center z-50">
                            <div className="bg-white border rounded-lg shadow-lg p-6 relative w-96 flex flex-col">
                                <h1 className='text-[#2A1F9D] font-bold'>Enable E-Mode</h1>
                                <button
                                    onClick={handleClickAway}
                                    className="absolute top-2 right-2 text-gray-500 hover:text-gray-700"
                                >
                                ...
                                <div className="flex flex-col gap-2 mt-5 text-sm">
                                    <div className="w-full">
                                        <div className="w-full flex flex-col my-3 space-y-2">
                                            <div className="w-full flex bg-[#96d6f1] p-1 rounded">
                                                <div className="w-1/12 flex items-center justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 mr-1 text-blue">
                                                ...
                                                <div className="w-11/12 text-xs text-[#2A1F9D] flex items-center ml-1">
                                            ...
                                            <div className="w-full">
                                                <div className="w-full text-[#2A1F9D] flex justify-between my-2">
                                                    <h1>Transaction overview</h1>
                                                </div>
                                                <div className="w-full bg-gray-100 hover:bg-gray-200 cursor-pointer p-3 rounded-md text-sm">
                                                    <div className="w-full flex flex-col my-1">
                                                        <div className="w-full flex justify-between items-center">
                                                            <p className='text-nowrap text-[#2A1F9D]'>E-mode Category</p>
                                                            <p>
                                                                <span className="ml-1 text-[#2A1F9D]">None</span>
                                                                <span className="text-[#2A1F9D] mx-1">→</span>
                                                                <span className="text-[#2A1F9D]">Stable Coins</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="w-full flex flex-col my-1">
                                                        <div className="w-full flex justify-between items-center text-[#2A1F9D]">
                                                            <p>Available Assets</p>
                                                            <p>
                                                                <span className="text-[#2A1F9D]">All Assets</span>
                                                                <span className="text-[#2A1F9D]">→</span>
                                                                <span className="break-all">
                                                                    abc,xyz,jkl,<br />stu,mno
                                                                </span>
                                                            </p>
                                                        </div>
                                                    </div>
