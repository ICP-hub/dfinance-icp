...
use crate::create_new_canister::create_ledger_canister;
...
#[ic_cdk::update]
async fn call_test () -> Result<Principal, String> {
    create_ledger_canister().await
}
...
pub async fn get_asset_data() -> HashMap<&'static str, (Principal, ReserveData)> {
    ...
    //         d_token_canister: Some(ckbtc_principal.to_string()),
    //         debt_token_canister: Some(ckbtc_principal.to_string()),
    //         total_supply: 0,
    //         total_borrowed:0,
