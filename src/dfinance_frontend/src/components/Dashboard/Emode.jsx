                    ...
                    <div className="absolute right-0 mt-2 w-80 flex items-center justify-center  ">
                        <div className="bg-white border rounded-lg shadow-lg p-6 relative w-full flex flex-col justify-between dark:bg-darkBackground dark:text-darkText">
                            ...
                            <div className='dark:bg-gradient dark:from-darkGradientStart dark:to-darkGradientEnd dark:text-darkText'>
                                <h2 className="text-xl font-semibold mb-4 dark:text-darkText">Efficiency mode (E-Mode)</h2>
...
{showFinalPopup && (
  <ClickAwayListener onClickAway={handleClickAway}>
    <div className="fixed inset-0 flex items-center justify-center z-50 ">
      <div className="bg-white dark:bg-gradient dark:bg-[#151f32]   rounded-lg shadow-lg p-6 relative w-96 flex flex-col">
        <h1 className='text-[#2A1F9D] font-bold dark:text-darkText'>Enable E-Mode</h1>
        <button
          onClick={handleClickAway}
          ...
          <div className="w-full">
            <div className="w-full flex flex-col my-3 space-y-2">
              <div className="w-full flex bg-[#96d6f1] dark:bg-[#59588C] p-1 rounded">
                <div className="w-1/12 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 mr-1 text-blue dark:text-[#96d6f1]">
                ...
                <div className="w-full bg-gray-100 dark:bg-[#1D1B40] hover:bg-gray-200 dark:hover:bg-[#3a3772] cursor-pointer p-3 rounded-md text-sm">
                  <div className="w-full flex flex-col my-1">
                    <div className="w-full flex justify-between items-center">
                      <p className='text-nowrap text-[#2A1F9D] dark:text-darkText'>E-mode Category</p>
                      <p>
                        <span className="ml-1 text-[#2A1F9D] dark:text-darkText">None</span>
                        <span className="text-[#2A1F9D] dark:text-darkText mx-1">→</span>
                        <span className="text-[#2A1F9D] dark:text-darkText">Stable Coins</span>
                      </p>
                    </div>
                  </div>
                  <div className="w-full flex flex-col my-1">
                    <div className="w-full flex justify-between items-center text-[#2A1F9D] dark:text-darkText">
                      ...
                      <p>
                        <span className="text-[#2A1F9D] dark:text-darkText">All Assets</span>
            ...
            <div className="w-full mt-3">
              <div className="flex items-center">
                <img src="/Vector.png" alt="Vector Image" className='w-4 h-4 mr-1 dark:text-darkText' />
                <h1 className=''>&lt;$1.23</h1>
                <div className="warning-icon-container">
                  <Info size={16} className="text-[#120f34] dark:text-darkText ml-1" />
                </div>
              </div>
              <div className="w-full">
                <button
