...
echo "debttoken got deployed with a transfer fee of ${TRANSFER_FEE}"
...
# echo "token_ledger got deployed with a transfer fee of ${TRANSFER_FEE}"
...
# echo "dtoken got deployed with a transfer fee of ${TRANSFER_FEE}"